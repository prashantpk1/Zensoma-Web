...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-xl-6"><img class="bg-img-cover bg-center" src="{{ static_asset('admin/assets/images/login/2.jpg') }}" alt="looginpage"></div>
          <div class="col-xl-6 p-0">
            <div class="login-card login-dark">
              <div>
                <div><a class="logo text-start" href="index.html"><img class="img-fluid for-light" src="{{ static_asset('admin/assets/images/logo/logo.png') }}" alt="looginpage"><img class="img-fluid for-dark" src="../assets/images/logo/logo_dark.png" alt="looginpage"></a></div>
                <div class="login-main">

                    <div id="login-message" class="alert txt-success border-success outline-2x alert-dismissible fade show alert-icons d-none" role="alert">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="theme-form" id="login-frm">
                        ...
                        <div class="form-group mb-0">
                            ...
                            </div><a class="link btn btn-sm" href="{{ route('forgot-passwords')}}">Forgot password?</a>
                        </div>

    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="myModal">
            <form class="form-bookmark needs-validation" method="post"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="category_id[]" id="category_id"
                                    class="form-select custom_select2 category_id" multiple>
                            ...
                            @foreach ($language as $key => $lang)
                                ...
                                <div class="col-md-6">
                                    <label class="col-form-label">
                                        <span class="required">{{ $lang['language'] }} Question Description <span
                                                class="text-danger">*</span></span>
                                    </label>
                                    <textarea type="text" name="description[{{ $lang['code'] }}][description]" id="key" class="form-control"
                                        @error('key') is-invalid @enderror>
                                        @if (!empty($array1[$lang['code']]['description']))
                                        {{ $array1[$lang['code']]['description'] }}
                                        @endif
                                        </textarea>
                                </div>
                            @endforeach
                ...
                <button class="btn btn-primary btn-sm btn-custom" type="submit" id="questionSubmit"><i

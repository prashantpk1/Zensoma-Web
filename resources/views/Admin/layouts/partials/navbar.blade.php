<div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper"><a href="#"><img class="img-fluid" src="{{ static_asset('admin/assets/images/logo/logo.png') }}" alt=""></a></div>
        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          <div class="media profile-media"><img class="b-r-10" style="height:35px;" src="{{ static_asset('profile_image/' . Auth::user()->profile_image) }}" alt="">
            <div class="media-body"><span>{{  Auth::user()->name }}</span>
              <p class="mb-0">@if(Auth::user()->user_type == 2) Admin  @else Sub Admin @endif <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>

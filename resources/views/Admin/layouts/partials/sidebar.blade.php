            ...
            <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                    ...
                    <ul class="sidebar-submenu">
                        ...
                        <li><a href="{{ route('theme.index') }}"
                                class="@if ($url == 'theme.index' || $url == 'theme.create' || $url == 'theme.edit') badge-light-primary active @endif">
                            Themes</a></li>
                        ...
                        <li><a href="{{ route('level.index') }}"
                                class="@if ($url == 'level.index' || $url == 'level.create' || $url == 'level.edit') badge-light-primary active @endif">User Level</a></li>
                        <li><a href="{{ route('badge.index') }}"
                                class="@if ($url == 'badge.index' || $url == 'badge.create' || $url == 'badge.edit') badge-light-primary active @endif">User Badges</a></li>
                        <li><a href="{{ route('gamification-config.index') }}"
                                class="@if ($url == 'gamification-config.index' || $url == 'gamification-config.create' || $url == 'gamification-config.edit') badge-light-primary active @endif">Gamification Config</a></li>
                        <li><a href="{{ route('tag.index') }}"
                                    class="@if ($url == 'tag.index' || $url == 'tag.create' || $url == 'tag.edit') badge-light-primary active @endif">Tags</a></li>
                ...
                <li class="sidebar-list"><a
                        ...
                        <svg class="fill-icon">
                            <use href="{{ static_asset('admin/assets/svg/icon-sprite.svg#fill-button') }}"> </use>
                ...
                <li class="sidebar-list"><a
                    ...
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav @if ($url == 'booking.index' || $url == 'booking.create' || $url == 'booking.edit') badge-light-primary @endif"

                        ...
                        @foreach ($language as $key => $lang)
                                    ...
                                    <div class="col-md-6">
                                        <label class="col-form-label">
                                            ...
                                            <input type="text" name="question[{{ $lang['code'] }}][question]" id="key" class="form-control" placeholder="Enter Question" @error('key') is-invalid @enderror value="@if (!empty($array[$lang['code']]['question'])){{ $array[$lang['code']]['question'] }}@endif">
                                    </div>
                        @endforeach
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="coupon_code">Option Type</label>
                                <select name="option_type" id="option_type" aria-label="Select a Option Type"
                                        data-placeholder="Select a Option Type..."
                                        class="form-select form-control">
                                        <option value="checkbox"  @if($data->option_type == "checkbox") selected="" @endif>Check Box</option>
                                        <option value="range" @if($data->option_type == "range") selected="" @endif>Range</option>
                                        <option value="radio" @if($data->option_type == "radio") selected="" @endif>Radio</option>
                                </select>
                        </div>

                        @php $total_option = 1; @endphp
                                ...
                                @foreach ($language as $key => $lang)
                                        ...
                                        <div class="col-md-6">
                                            <label class="col-form-label">
                                                ...
                                                <input type="text" name="option[{{ $lang['code'] }}][option0]" id="key" class="form-control" placeholder="Enter Option" @error('key') is-invalid @enderror required>
                                        </div>
                                @endforeach
                        @endif
                        <div class="col-10">
                            ...
                            <div class="col-2">
                                <ol class="breadcrumb">
                                         ...
                                         <button type="button"
                                        class="btn btn-sm btn-primary" id="add_option_edit"><i

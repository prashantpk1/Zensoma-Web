          ...
          <div class="card-body custom-input">
             <form class="row g-3" method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" id="profile-submit">
              ...
              <div class="col-6">
                ...
                <input class="form-control  @error('designation') is-invalid @enderror" id="designation" name="designation" type="designation" placeholder="Enter Designation" value="{{ Auth::user()->designation }}">
                @error('designation')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-6">
                <label class="form-label" for="exampleFormControlTextarea19">Biography <span class="text-danger">*</span></label>
                <textarea class="form-control input-air-primary" id="exampleFormControlTextarea19" rows="3" name="biography">{{ Auth::user()->biography }}</textarea>
                @error('biography')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-6">
                <label class="form-label" for="exampleFormControlTextarea19">Skill <span class="text-danger">*</span></label>
                <input name="basic" id="skill" value="{{ Auth::user()->skill }}" class="form-control" >
                @error('basic')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
      ...
      <div class="col-xl-12">
        <div class="card height-equal">
          ...
          <div class="card-body custom-input">
            ...
            <div class="col-12">
                <input type="submit" class="btn btn-primary" value="Submit" id="change-passwordSubmit">
                <a href="{{ route('dashboard') }}" class="btn btn-light">Cancel</a>
              </div>
            </form>
          </div>

            ...
            <div class="col-xl-12">
                <div class="card height-equal">
                    ...
                    <div class="card-body custom-input">
                        ...
                        action="{{ route('my-session.update', $data->id) }}" enctype="multipart/form-data" id="content-frm-edit">
                        @csrf
                        @method('PUT')
                                    ...
                                    @php $session_video_array = $session_video['video_title']; @endphp
                                        ...
                                        <div class="col-sm-2">
                                            <br>
                                                    ...
                                                    <a href="{{ route('remove.video1', $session_video->id) }}" class="btn btn-light" onclick="return confirm('Are you sure you want to remove this video?');">
                        ...
                        <a href="{{ route('my-session.index') }}" class="btn btn-light">Cancel</a>

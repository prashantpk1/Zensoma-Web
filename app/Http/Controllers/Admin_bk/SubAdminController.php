...
class SubAdminController extends Controller
{
        ...
        try {
            ...
            if (!empty($data)) {
               ...
               $email =  $data->email;
                ...
                return response()->json(['status' => '1', 'success' => 'Sub Admin Added Successfully.']);
                //
            }
        } catch (Exception $ex) {
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            $data->save();
            if (!empty($data)) {
                return response()->json(['status' => '1', 'success' => 'Sub Admin Update Successfully.']);
            }
        } catch (Exception $ex) {
            return response()->json(
                ['success' => false, 'message' => $ex->getMessage()]
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return response()->json(['status' => '1', 'success' => 'Sub Admin Deleted Successfully']);
        } catch (\Exception $e) {
    ...
    public function subadminStatus($id)
    {
        try {
            ...
            $data->update();
            DB::commit(); // Commit Transaction
            return response()->json(['status' => '1', 'success' => 'Sub Admin ' . $message . ' Successfully']);
        } catch (\Exception $e) {
            DB::rollBack(); //Rollback Transaction
            return redirect()->back()->withErrors(['error' => $e->getMessage()]);
        } catch (\Throwable $e) {
